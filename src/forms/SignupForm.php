...
class SignupForm extends \yii\base\Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['i_agree', 'i_agree_pp'], 'boolean'],
            ['i_agree', 'required', 'requiredValue' => 1, 'message' => Yii::t('hiam', 'Please consider terms of use.')],
            ['i_agree_pp', 'required', 'requiredValue' => 1, 'message' => Yii::t('hiam', 'Please consider Privacy Policy.')],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'i_agree_pp' => Yii::t('hiam', 'I agree to the') . ' ' . Html::a(Yii::t('hiam', 'Privacy Policy'), Yii::$app->params['legals.privacyPolicyUrl']),
        ];
    }
}
